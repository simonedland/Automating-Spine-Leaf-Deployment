#todo:
#find out what ip it should use (can probably use some code from microsegment.py and also base the desision of host.yaml group name)
...
#ignore STP due to the switches only beeing connected to one another unless the server is switched
